...
public class VariableString {
	...
	//              especial llamada String que es usada para el manejo de cadenas.
      	...
      	int mi_variable;	// declaracion de la variable en Java

     	// definición de una variable tipo caracter o string
	// use este valor primero
	mi_variable = 1235;
	
	// Luego use este valor para ver el error. Quite la dobble
	// barra de división de la sentencia de abajo
	// mi_variable =1235.67

	System.out.println(""); // no hay forma directa de borrar la consola en Java
	System.out.println("Una variable tipo entero es aquella que contiene");
	System.out.println("números sin coma decimal ni decimales. Si intenta");
	System.out.println(" agregar decimales, el IDE mostrara un error");
	System.out.println(" ");
